<template>
  <header v-loading="loading">
    ...
    <el-scrollbar wrap-class="scrollbar-wrapper">
      <el-menu :default-active="activeIndex" class="side-menu-list sub-menu-list" :router="true"
        :unique-opened="true" :collapse-transition="false" mode="vertical">
        <template v-for="nav in navList">
          <el-submenu :key="nav.id" :index="nav.id">
            ...
            <el-menu-item :index="subMenu.url" v-for="(subMenu, subIndex) in nav.children"
              :key="subIndex" @click="menuClick(subMenu)">
