<template>
  <div class="main-content" style="padding-top:0px;padding-bottom:0px">
    ...
    <el-form :inline="true">
      ...
      <el-form-item label="">
        <el-input v-model="searchParams.code" placeholder="请输入商户编码..." clearable
          size="mini"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="name" label="商户名称" width="150px"
      ...
      <el-table-column prop="companyName" label="公司名称" width="150px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="businessCertificatesNo" label="营业执照编号"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="companyOwner" label="联系人" width="100px"
        show-overflow-tooltip></el-table-column>
      ...
      <el-table-column v-if="queryType==2" label="审核状态" width="100px" min-width="80px"
        align="center" :formatter="formatAuditState"></el-table-column>
