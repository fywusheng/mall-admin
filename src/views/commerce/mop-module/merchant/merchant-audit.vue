<template>
  <el-dialog class="dialog" :title="dataForm.id ? '审核商户信息':'审核商户信息'" width="550px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="审核意见" prop="auditRemarks">
        <el-input v-model="dataForm.auditRemarks" placeholder="请输入审核意见..." maxlength="60" rows="5"
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" :loading="sending" :disabled="sending" @click="save(1)">
        {{sending ?'正在保存...':'批准'}}
      </el-button>
    </div>
  </el-dialog>
