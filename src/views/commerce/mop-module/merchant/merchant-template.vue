<template>
  <el-dialog class="dialog" :title="dataForm.id ? '修改商户信息':'新增商户信息'" width="550px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="商户名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入商家名称..." maxlength="64"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="商户描述" prop="description">
        <el-input v-model="dataForm.description" placeholder="请输入商家描述..." maxlength="60"
          type="textarea" style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="公司名称" prop="companyName">
        <el-input v-model="dataForm.companyName" placeholder="请输入公司名称..." maxlength="64"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="公司电话" prop="companyPhone">
        <el-input v-model="dataForm.companyPhone" placeholder="请输入联系电话..." maxlength="256"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="负责人" prop="companyOwner">
        <el-input v-model="dataForm.companyOwner" placeholder="请输入商家负责人..." maxlength="256"
          style="width:100%"></el-input>
      </el-form-item>
    </el-form>
