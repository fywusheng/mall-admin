<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑展示类目':'创建展示类目'" width="600px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="类目名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入展示类目名称..." style="width:100%"
          maxlength="32"></el-input>
      </el-form-item>
      <el-form-item label="上级类目" prop="parentName">
        <el-input v-model="dataForm.parentName" disabled style="width:100%"
          maxlength="32"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(response, file) {
      ...
      this.dataForm.iconUrl = file.response.data.absoluteUrl;
    },
