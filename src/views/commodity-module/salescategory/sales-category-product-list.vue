<template>
  <div class="main-content">
    <el-page-header @back="back2Prev" content="运营类目商品列表"></el-page-header>
    ...
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.productId" placeholder="请输入商品ID..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" @click="changePage(1)"
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="code" label="商品编码" width="100px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="brandId" label="所属品牌" width="100px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="categoryNode" label="所属类目" width="150px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="updatedTime" label="关联时间" width="150px"
        show-overflow-tooltip></el-table-column>
