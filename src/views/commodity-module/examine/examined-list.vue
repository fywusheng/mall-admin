      ...
      <el-row class="mb-2">
         <el-form-item label="">
          ...
          <el-form-item style="background:#F2F6FC">
            ...
            <el-button type="primary" size="mini" icon="el-icon-tickets" @click="handleExamined(1)">批量审核</el-button>
          </el-form-item>
      </el-row>
    </el-form>

    <!-- 之前的按样式 改成 tab 样式 -->
    <el-tabs v-if="countMap" v-model="activeType" @tab-click="handleClick" style="padding-top:0">
      <el-tab-pane :label="`待审核 (${countMap[2].countNum})`" name="2"></el-tab-pane>
      <el-tab-pane :label="`审核未通过 (${countMap[3].countNum})`" name="3"></el-tab-pane>
      <el-tab-pane :label="`审核通过 (${countMap[4].countNum})`" name="4"></el-tab-pane>
    </el-tabs>
