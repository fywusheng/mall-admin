<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑卖场信息':'创建卖场信息'" width="550px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="卖场名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入卖场名称..." maxlength="64"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="生效时间" prop="activityTime">
        <div>
          <el-date-picker type="datetimerange" size="small" v-model="dataForm.activityTime"
      ...
      <el-form-item label="卖场描述" prop="description">
        <el-input v-model="dataForm.description" placeholder="请输入卖场描述..." maxlength="256"
