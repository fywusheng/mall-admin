  ...
  <div class="div-layout">
    ...
    <el-row>
      <el-col>
        <el-form :inline="true">
          <el-form-item label="">
            <el-input v-model="searchParams.code" placeholder="请输入商品ID..." clearable
              size="mini"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" icon="el-icon-search" @click="loadData" size="mini">查
              询</el-button>
            <el-button type="default" icon="el-icon-circle-plus-outline" @click="add" size="mini">新
              增</el-button>
          </el-form-item>
        </el-form>
      </el-col>
      ...
      <el-table-column prop="" label="操作" align="center" width="100px">
        <template slot-scope="scope">
          <el-link icon="el-icon-delete" :underline="false"
            @click="remove(scope.row)">移除&nbsp;&nbsp;</el-link>
        </template>
      </el-table-column>
    </el-table>
