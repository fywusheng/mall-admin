<template>
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.name" placeholder="请输入销售排期名称..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="startTime" label="生效时间" :formatter="formatEffectiveTime" align="center"
        width="290px"> </el-table-column>
      ...
      <el-table-column prop="" label="操作" align="center" width="280px">
        <template slot-scope="scope">
          ...
          <el-button size="mini" icon="el-icon-delete" @click="del(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
