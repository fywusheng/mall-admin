  ...
  <div class="main-content" style="padding-top:0px;padding-bottom:0px">
    ...
    <el-form :inline="true">
      <el-row class="mb-2">
        ...
        <el-form-item>
          ...
          <el-button type="default" v-if="activeType==1" icon="el-icon-circle-plus-outline"
            size="mini" @click="audit(0)">审核</el-button>
        </el-form-item>
      </el-row>
    </el-form>
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="categoryNode" label="所属类目" width="150px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="merchantId" label="所属商户" width="150px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="auditState" label="审核状态" width="100px" align="center"
        :formatter="formatAuditState"></el-table-column>
      <el-table-column prop="auditTimeTime" label="审核时间" width="150px" v-if="activeType==3"
        align="center"></el-table-column>
      <el-table-column prop="createdTime" label="创建时间" width="150px"
        align="center"></el-table-column>
      <el-table-column prop="updatedTime" v-if="activeType==1" label="提审时间" width="150px"
        align="center"></el-table-column>
      <el-table-column prop="updatedTime" v-if="activeType==2" label="审核时间" width="150px"
        align="center"></el-table-column>
      <el-table-column prop="" label="操作" align="center" width="280px">
        <template slot-scope="scope">
          <el-button size="mini" :disabled="scope.row.auditState===0"
            @click="forward2SpecPage(scope.row)">查看SKU</el-button>
          <el-button size="mini" v-if="activeType==1" icon="el-icon-success"
            @click="audit(1,scope.row)">审 核</el-button>
        </template>
      </el-table-column>
    </el-table>
