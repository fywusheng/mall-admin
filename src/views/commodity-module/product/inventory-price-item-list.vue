  ...
  <div class="div-layout">
    ...
    <el-row>
      <el-col>
        <el-form :inline="true">
          <el-form-item label="">
            <el-input v-model="searchParams.code" placeholder="请输入SKU ID..." clearable
              size="mini"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="resultMessage" label="处理结果" width="150px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="createdTime" label="处理时间" width="150px"
