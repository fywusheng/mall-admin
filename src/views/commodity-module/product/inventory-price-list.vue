  ...
  <div class="div-layout">
    <el-row>
      <el-col>
        <el-form :inline="true">
          <el-form-item label="">
            <el-input v-model="searchParams.skuId" placeholder="请输入SKU ID..." clearable
              size="mini"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="batchNo" label="变更批次号" width="150px" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="auditState" label="审核状态" :formatter="formatAuditState" align="center"
        width="100px"> </el-table-column>
      <el-table-column prop="resultStatus" label="处理状态" :formatter="formatExeState" align="center"
        width="100px"> </el-table-column>
      <el-table-column prop="resultMessage" label="处理结果" width="200px"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="updatedTime" label="处理时间" width="150px" align="center">
      </el-table-column>
      <el-table-column prop="createdTime" label="创建时间" width="150px"
        align="center"></el-table-column>
      <el-table-column prop="" label="操作" align="center" width="270px">
        <template slot-scope="scope">
          <el-button icon="el-icon-view" @click="forward2DetailsPage(scope.row)"
            size="mini">查看</el-button>
          <el-button icon="el-icon-success" :disabled="scope.row.auditState!==2"
            @click="audit(scope.row)" size="mini">审核</el-button>
          <el-button icon="el-icon-delete" :disabled="scope.row.auditState!==2"
            @click="del(scope.row)" size="mini">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination background v-show="totalCount > 10" :page-size="pageSize"
