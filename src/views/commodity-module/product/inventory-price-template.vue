<template>
  <el-dialog class="dialog" :title="dialogTitle" width="550px" :visible.sync="showDialog">
      ...
      <div>
        ...
        <el-form-item label="变更文件" prop="fileUrl">
          <el-upload class="upload-demo" :on-success="handleAvatarSuccess"
            :before-upload="beforeAvatarUpload" :on-error="handleUploadFailure" multiple :limit="1"
            accept=".xlsx" :file-list="fileList">
