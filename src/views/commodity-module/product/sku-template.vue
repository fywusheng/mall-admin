<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑SKU' : '创建SKU'" width="900px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-row type="flex">
        ...
        <el-col :span="22">
          <el-table ref="spec_mytable" :data="attr_tableData" style="width: 100%; font-size: 10px">
            <el-table-column type="index" label="序号"></el-table-column>
            <el-table-column prop="name" label="规格项" width="100px"></el-table-column>
            <el-table-column label="规格参数值">
              <div slot-scope="scope">
                <el-radio-group @change="checkSpec(scope.row)" v-model="scope.row.attrValSelected"
                  :disabled="scope.row.isReadonly" size="small">
                  <el-radio-button v-for="attrVal in scope.row.attrValList" :label="attrVal.id"
