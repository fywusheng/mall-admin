<template>
  <el-dialog class="dialog" :title="itemForm.id ? '编辑数据参数':'创建数据参数'" width="600px"
    :visible.sync="showDialog">
    <el-form class="data-form" :model="itemForm" :rules="dataRules" ref="itemForm"
      label-width="150px" label-position="right">
      <el-form-item label="数据类型" prop="name">
        <el-input v-model="itemForm.name" :disabled="true" maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="数据参数名" prop="label">
        <el-input v-model="itemForm.label" placeholder="请输入数据显示名称..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="数据参数值" prop="value">
        <el-input v-model="itemForm.value" placeholder="请输入数据显示名称..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="备注信息" prop="description">
        <el-input v-model="itemForm.description" placeholder="请输入备注信息..." type="textarea"
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" :loading="sending" :disabled="sending"
        @click="save">{{sending ? '正在保存...':'确定'}}</el-button>
    </div>
  </el-dialog>
</template>
<script>
