<template>
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.name" placeholder="请输入数据名称..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="searchParams.code" placeholder="请输入数据编码..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList" size="mini" v-loading="loading">
      ...
      <el-table-column prop="updatedTime" label="操作时间" align="center"
      ...
      <el-table-column prop="" label="操作" align="center" width="280px">
        <template slot-scope="scope">
          <el-link icon="el-icon-info" :underline="false"
            @click="forward2DetailsPage(scope.row)">数据项&nbsp;</el-link>
    ...
    <el-pagination background v-show="totalSize > 10" :page-sizes="[10, 20, 50]"
