        ...
        <tr>
          ...
          <td>
            <el-form-item label="设置新密码" prop="passwordNew01">
              <el-input v-model="dataForm.passwordNew01" placeholder="设置新密码，请输入..." maxlength="16"
        ...
        <tr>
          ...
          <td>
            <el-form-item label="确认新密码" prop="passwordNew02">
              <el-input v-model="dataForm.passwordNew02" placeholder="请再次重复输入以确保无误..."
                maxlength="16" style="width:100%"></el-input>
            </el-form-item>
          </td>
          <td width="30%"></td>
        </tr>
    ...
    <el-row type="flex" style="height:30px;text-align:center">
      <el-col :span="24" style="align:center">
        <el-button type="primary" :loading="sending" :disabled="sending"
          @click="save">{{ sending ? '正在保存...' : '提交' }}</el-button>
      </el-col>
    </el-row>
  </div>
</template>
