<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑管理员信息':'创建管理员'" width="600px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="姓名" prop="realName" class="item">
        <el-input v-model="dataForm.realName" placeholder="请输入管理员姓名..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="登录账号" prop="loginName" class="item">
        <el-input v-model="dataForm.loginName" placeholder="请输入登录账号(手机号码)..."
      ...
      <el-form-item label="所属部门/组织" prop="fullOrgIds" class="item">
        <el-cascader v-model="dataForm.fullOrgIds" :options="orgOptions" placeholder="请选择所属部门..."
          :props="orgOptionProps" style="width:500px"></el-cascader>
      </el-form-item>
      <el-form-item label="从事岗位" prop="positionId" class="item">
        <el-select v-model="dataForm.positionId" placeholder="请选择所从事的岗位..." style="width:100%">
          <el-option v-for="item in positionOptions" :key="item.id" :label="item.name"
  ...
  data() {
    ...
    return {
      ...
      dataRules: {
        ...
        fullOrgIds: [{ required: true, message: '所属部门不能为空,请输入...', trigger: 'change' }],
        positionId: [{ required: true, message: '从事岗位不能为空,请输入...', trigger: 'change' }]
      }
    }
  },
