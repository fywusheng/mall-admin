<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑岗位信息':'创建岗位信息'" width="600px"
    :visible.sync="showDialog">
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      label-width="150px" label-position="top">
      <el-form-item label="岗位名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入岗位名称..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="岗位描述" prop="description">
        <el-input v-model="dataForm.description" placeholder="请输入岗位描述..." type="textarea"
          style="width:100%"></el-input>
      </el-form-item>
    </el-form>
