<template>
  <el-dialog class="dialog" :title="dataForm.id ? '编辑业务':'创建业务'" width="600px"
    :visible.sync="showDialog">
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      label-width="150px" label-position="top">
      <el-form-item label="名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="请输入应用名称..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="图标" prop="icon">
        <el-input v-model="dataForm.icon" placeholder="请选择业务图标..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="系统" prop="appIds" style="width:100%">
        <el-select v-model="dataForm.appIds" placeholder="请选择所属系统的清单..." multiple
          style="width:100%">
      ...
      <el-form-item label="序号" prop="sort">
        <el-input v-model="dataForm.sort" placeholder="请输入业务显示序号..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="描述" prop="description">
        <el-input v-model="dataForm.description" placeholder="请输入业务描述信息..." type="textarea"
