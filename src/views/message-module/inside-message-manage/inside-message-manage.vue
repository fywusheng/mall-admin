  ...
  <div class="app-container">
    <el-form class="search-form clearfix" v-show="showSearchBox" :inline="true" size="small">
      ...
      <el-form-item class="fr">
        ...
        <el-button class="head-item" type="default" icon="el-icon-circle-plus-outline" size="mini" @click="dialogFormVisible = true">发送站内信息</el-button>
      </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    async loadInsideMessageList() {
      ...
      try {
        const { type, data } = await post(path + "/wbst/msg/getWbstMsgListByParam", params)
        if (type === "success") {
    ...
    async handleSendMessage() {
      ...
      try {
        const { type } = await post(path + "/wbst/send/singlemsg", params)
        if (type === "success") {
          this.$message({
            type: "success",
            message: "发送成功!"
