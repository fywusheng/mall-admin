...
<div class="app-container">
  <el-form class="template-search-box-body search-form clearfix" v-show="showSearchBox" :inline="true" size="small">
    ...
    <el-form-item class="fr">
      ...
      <el-button class="head-item" type="default" icon="el-icon-circle-plus-outline" size="mini" @click="onClickAddTemplate">添加</el-button>
    </el-form-item>
  </el-form>
  ...
  <div class="table-wrap">
    ...
    <el-table ref="templateTable" v-loading="listLoading" :data="templateList" element-loading-text="加载中..." highlight-current-row>
