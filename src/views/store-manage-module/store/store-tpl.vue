<template>
  <div class="div-layout">
    <el-page-header
      @back="back2Prev"
      :content="`${routeParamsId == -1 ? '创建' : '编辑'}门店`"
    ></el-page-header>
      ...
      <table width="100%">
        <tr>
          ...
          <td width="30%">
            <el-form-item
              label="门店编号："
              prop="storeNo"
              class="item required-item"
            >
              <el-input
                v-model="dataForm.storeNo"
                disabled
                :placeholder="`${
                  routeParamsId != -1
                    ? '请输入门店编号...'
        ...
        <tr>
          ...
          <td width="30%">
            ...
            >
              <el-input
                v-model="dataForm.storeManagerName"
                placeholder="请输入店长姓名..."
                maxlength="20"
                style="width: 80%"
              ></el-input>
      ...
      <!-- <table width="100%">
        <tr>
          ...
          <td width="30%">
            <el-form-item
              label="佣金计算方式："
              prop="commissionCalculation"
              class="item"
            >
              <el-input
                v-model="dataForm.commissionCalculation"
                placeholder="请输入佣金计算方式..."
                maxlength="32"
                style="width: 80%"
              ></el-input>
            </el-form-item>
          ...
          <td width="30%">
            ...
            >
              <el-input
                v-model="dataForm.commissionSettlement"
                placeholder="请输入佣金结算方式..."
                maxlength="32"
                style="width: 80%"
              ></el-input>
            </el-form-item>
      ...
      <table width="100%">
        <tr>
          ...
          <td width="30%">
            ...
            >
              <el-input
                v-model="dataForm.corporateAccount"
                placeholder="请输入对公账户户名..."
                maxlength="32"
                style="width: 80%"
              ></el-input>
            </el-form-item>
          ...
          <td width="30%">
            ...
            >
              <el-input
                v-model="dataForm.corporateBank"
          ...
          <td width="30%">
            <el-form-item
              label="开户银行及支行："
              prop="corporateBankBranch"
              class="item"
            >
              <el-input
                v-model="dataForm.corporateBankBranch"
          ...
          <td width="90%" colspan="3">
            <el-form-item label="" prop="enterpriseInformation" class="item">
              <el-input
                ...
                v-model="dataForm.enterpriseInformation"
                placeholder="请输入企业信息..."
                maxlength="32"
                style="width: 93%"
              ></el-input>
...
export default {
  ...
  data() {
    ...
    const isPhoneNumber = (rule, value, callback) => {
      ...
      const patter =
        /^((13[0-9])|(17[0-9])|(14[5|7])|(15([0-3]|[5-9]))|(18[0-9]))\d{8}$/;
      if (!patter.test(value)) {
  ...
  methods: {
    ...
    async handlerSave() {
      if (!this.dataForm.address)
        return this.$message.warning("门店详细地址不能为空，请输入！");
