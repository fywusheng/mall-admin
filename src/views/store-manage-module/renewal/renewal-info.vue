      ...
      <table width="100%">
        <tr>
          ...
          <td width="30%">
            ...
            >
              <el-date-picker
                v-model="dataForm.newPeriodData"
                type="daterange"
        ...
        <tr>
          ...
          <td width="30%">
            <el-form-item
              label="经营范围："
              prop="newBusinessScope"
              class="item"
              label-position="top"
            >
              <el-cascader
                class="_cascader _businessScope"
                v-model="dataForm.newBusinessScope"
                :options="categoryOptions"
                placeholder="请选择经营范围..."
                clearable
                :props="{
          ...
          <td width="30%">
            <el-form-item
              label="经营品牌："
              prop="newOperatingBrand"
              class="item"
              label-position="top"
            >
              <el-select
                v-model="dataForm.newOperatingBrand"
                multiple=""
                filterable
                style="width: 80%"
                clearable
  ...
  methods: {
    ...
    async loadData(productId) {
      ...
      if (result.code == 200) {
        ...
        result.data.businessScope = this.formatSalesArea(
          result.data.businessScope,
          3
        );
    ...
    save() {
      this.$refs.dataFormInfor.validate(async (valid) => {
        if (valid) {
          ...
          params.businessScope = JSON.stringify(params.newBusinessScope);
