<template>
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.orderCode" placeholder="请输入系统交易订单号..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="searchParams.paymentNo" placeholder="请输入第三方交易号..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="bizType" label="交易类型" :formatter="formatBizType" width="80px"
      ...
      <el-table-column prop="orderType" label="订单类型" :formatter="formatOrderType" width="80px"
        align="center"></el-table-column>
      <el-table-column prop="orderCode" label="订单号" width="160px" align="center"></el-table-column>
      <el-table-column prop="paymentAmounts" label="交易金额" width="80px"
        align="center"></el-table-column>
      <el-table-column prop="onlineAmounts" label="线上金额" width="80px"
        align="center"></el-table-column>
      <el-table-column prop="depositAmounts" label="余额金额" width="80px"
        align="center"></el-table-column>
      <el-table-column prop="paymentState" label="交易状态" :formatter="formatPaymentState" width="80px"
        align="center"></el-table-column>
      <el-table-column prop="paymentTime" label="交易时间" width="150px"
        align="center"></el-table-column>
    </el-table>
