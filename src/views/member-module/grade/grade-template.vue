<template>
  <el-dialog class="dialog" :title="'修改会员等级权益'" width="550px" :visible.sync="showDialog">
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="会员等级" prop="gradeName">
        <el-input v-model="dataForm.gradeName" placeholder="请输入会员等级名称..." maxlength="32"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="升级阈值" prop="thresholdValue">
        <el-input v-model="dataForm.thresholdValue" placeholder="请输入等级升级阈值(门槛)..." maxlength="6"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="等级权益" prop="gradeRights">
        <el-input v-model="dataForm.gradeRights" placeholder="请输入会员等级权益描述..." type="textarea"
          rows="5" style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="备注信息" prop="remarks">
        <el-input v-model="dataForm.remarks" placeholder="请输入备注信息..." maxlength="256"
          style="width:100%"></el-input>
      </el-form-item>
    </el-form>
