<template>
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.loginName" placeholder="请输入用户登陆账号..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="searchParams.id" placeholder="请输入用户ID..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="searchParams.phone" placeholder="请输入手机号码..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="" label="操作" align="center" width="80px">
        <template slot-scope="scope">
          <el-link icon="el-icon-document" :underline="false"
            @click="forward2ProfilePage(scope.row)">详情</el-link>
        </template>
      </el-table-column>
    </el-table>
