  ...
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        ...
        <el-form-item label="">
          <el-input v-model="searchParams.userMobile" placeholder="请输入会员手机号码..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-select v-model="searchParams.orderStatus" collapse-tags filterable style="width:100%"
            size="mini" placeholder="请选择订单状态...">
    ...
    <el-table class="custom-table" :data="dataList"
      ...
      <el-table-column prop="orderId" label="订单编号" width="190px" align="center">
        <template slot-scope="scope">
          <el-link :underline="false"
            @click="forward2DetailsPage(scope.row)">{{scope.row.orderId}}</el-link>
        </template>
      </el-table-column>
      <el-table-column prop="receiveName" label="收货人" width="120px"></el-table-column>
      <el-table-column prop="receivePhone" label="联系电话" width="120px"
        align="center"></el-table-column>
      <el-table-column prop="orderStatusLabel" label="收货地址" :formatter="formatReceiveAddress"
        show-overflow-tooltip></el-table-column>
      <el-table-column prop="orderAmount" label="订单金额" width="100px"></el-table-column>
      <el-table-column prop="orderStatusLabel" label="订单状态" width="100px"
        align="center"></el-table-column>
