<template>
  <el-dialog class="dialog" :title="dataForm.id ? '修改退货地址':'新增退货地址'" width="550px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="所属商家" prop="supplierId">
        <el-select v-model="dataForm.supplierId" collapse-tags disabled filterable
          style="width:100%" placeholder="请选择商家...">
      ...
      <el-form-item label="收货人姓名" prop="exchangedName">
        <el-input v-model="dataForm.exchangedName" placeholder="请输入收货人姓名..." maxlength="64"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="联系电话" prop="exchangedPhone">
        <el-input v-model="dataForm.exchangedPhone" placeholder="请输入联系电话..." maxlength="11"
          style="width:100%"></el-input>
      </el-form-item>
      <el-form-item label="所在省/市/区" prop="administrativeArea">
        <el-cascader v-model="dataForm.administrativeArea" :options="administrativeAreaOptions"
