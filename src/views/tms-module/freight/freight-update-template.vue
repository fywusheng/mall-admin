<template>
  ...
  <div class="div-layout">
    <el-page-header @back="back2Prev" content="新增/修改运费模板"></el-page-header>
        ...
        <tr>
          ...
          <td width="55%">
            <el-form-item label="模版名称" prop="tempName">
              <el-input v-model="dataForm.tempName" placeholder="请输入模板名称..." maxlength="64"
        ...
        <tr>
          ...
          <td width="55%">
            <el-form-item label="是否包邮" prop="postage">
              <table width="100%">
                <tr>
                  <td width="45%">订单满(元)：<el-input v-model="dataForm.postage"
                      placeholder="请输入订单包邮起价金额..." style="width:200px" maxlength="64"></el-input>
                  </td>
                  <td width="20%">
    ...
    <el-form class="data-form" :model="templateDetail" :rules="tempRuler" ref="dataForm"
      label-width="150px" label-position="top" size="mini">
      <table width="100%">
        <tr>
          <td width="5%"></td>
            ...
            <el-form-item label="默认运费" prop="defaultFreight">
              <table width="100%">
                <tr style="height:50px">
                  <td width="45%">
                    首重(件)：<el-input v-model="templateDetail.first" placeholder="请输入首重(件)数量..."
                      maxlength="64" style="width:50%"></el-input>
                  </td>
                  <td width="55%">
                    首费(元)：<el-input v-model="templateDetail.firstPrice" placeholder="请输入首重(件)费用..."
                      maxlength="64" style="width:50%;"></el-input>
                  </td>
                </tr>
              </table>
          ...
          <td width="55%">
            <el-form-item label="默认续费" prop="defaultAddFreight">
              <table width="100%">
                <tr style="height:50px">
                  <td width="45%">
                    续重(件)：<el-input v-model="templateDetail.renew" placeholder="请输入续重(件)数量..."
                      maxlength="64" style="width:50%"></el-input>
                  </td>
                  <td width="55%">
                    续费(元)：<el-input v-model="templateDetail.renewPrice" placeholder="请输入续重(件)费用..."
                      maxlength="64" style="width:50%"></el-input>
                  </td>
                </tr>
              </table>
    ...
    async save() {
      this.$refs.dataForm.validate(async valid => {
        if (valid) {
          ...
          let result = {}
          if (this.id) {
            result = await post('/tms/freight-template/update', params)
          } else {
            result = await post('/tms/freight-template/add', params)
          }
          this.sending = false
          if (result.code == 200) {
