<template>
  <div class="main-content">
    <el-row class="mb-2">
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.tempName" placeholder="请输入模板名称..." clearable
            size="mini"></el-input>
        </el-form-item>
        <el-form-item label="">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" @click="queryByParams"
            size="mini">查询</el-button>
          <el-button type="default" icon="el-icon-circle-plus-outline" size="mini"
            @click="add">新增(A)</el-button>
        </el-form-item>
      </el-form>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push({ name: 'Freight-Modify-Template' })
      //TODO 将现在的add 替换删除掉
