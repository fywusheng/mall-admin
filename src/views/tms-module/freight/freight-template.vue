<template>
  <!-- TODO 运费模板上线时候废弃 -->
  <el-dialog class="dialog" :title="dataForm.id ? '修改运费模板':'新增运费模板'" width="700px"
    ...
    <el-form class="data-form" :model="dataForm" :rules="dataRules" ref="dataForm"
      ...
      <el-form-item label="所属商家" prop="supplierId">
        <el-select v-model="dataForm.supplierId" collapse-tags filterable style="width:100%"
          placeholder="请选择商家...">
      ...
      <el-form-item label="是否包邮" prop="postage">
        <table width="100%">
          <tr style="height:40px">
            ...
            <td width="35%">
              <el-input v-model="dataForm.postage" placeholder="请输入订单包邮起价金额..." maxlength="64"
      ...
      <el-form-item label="默认运费" prop="defaultFreight">
        <table width="100%">
          <tr style="height:50px">
            ...
            <td width="35%">
              <el-input v-model="templateDetail.first" placeholder="请输入首重(件)数量..." maxlength="64"
                style="width:95%"></el-input>
            </td>
            <td width="15%" style="text-align:right">首费(元)：</td>
            <td width="35%">
              <el-input v-model="templateDetail.firstPrice" placeholder="请输入首重(件)费用..."
                maxlength="64" style="width:95%"></el-input>
            </td>
          </tr>
          <tr style="height:50px">
            <td width="15%" style="text-align:right">续重(件)：</td>
            <td width="35%">
              <el-input v-model="templateDetail.renew" placeholder="请输入续重(件)数量..." maxlength="64"
                style="width:95%"></el-input>
            </td>
            <td width="15%" style="text-align:right">续费(元)：</td>
            <td width="35%">
              <el-input v-model="templateDetail.renewPrice" placeholder="请输入续重(件)费用..."
                maxlength="64" style="width:95%"></el-input>
            </td>
          </tr>
        </table>
