<template>
  <el-dialog class="dialog" :title="'商品列表'" width="950px" :visible.sync="showDialog">
    <div>
      <el-row>
        <el-form :inline="true">
          <el-form-item label="">
          ...
          <el-form-item>
            ...
            <el-button type="default" icon="el-icon-connection" @click="returnSelectionOptions"
              size="mini">返回数据</el-button>
          </el-form-item>
        </el-form>
      </el-row>
