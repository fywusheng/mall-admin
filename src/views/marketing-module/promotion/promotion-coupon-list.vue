<template>
  <el-dialog class="dialog" :title="'促销活动优惠券清单'" width="850px" :visible.sync="showDialog">
    <el-row>
      <el-form :inline="true">
        <el-form-item label="">
          <el-input v-model="searchParams.name" placeholder="请输入优惠券名称..." clearable size="mini"
            style="width:200px"></el-input>
        </el-form-item>
        <el-form-item label="">
          <el-input v-model="searchParams.code" placeholder="请输入优惠券编码..." clearable size="mini"
            style="width:200px"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table ref="tableRef" class="custom-table" :data="dataList"
      ...
      <el-table-column prop="type" label="优惠券类型" width="100px"
        :formatter="formatCouponType"></el-table-column>
      ...
      <el-table-column prop="shareState" label="允许转赠" :formatter="formatShareState" align="center"
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" :loading="sending" :disabled="sending" @click="saveSelection">
        {{sending ? '正在保存...':'关联'}}
      </el-button>
    </div>
  </el-dialog>
