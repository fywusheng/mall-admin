<template>
  <el-dialog class="dialog" :title="'促销活动用户范围'" width="850px" :visible.sync="showDialog">
    <div class="main-content">
      <el-row class="mb-2">
        <el-form :inline="true">
          <el-form-item label="">
            <el-input v-model="searchParams.memberId" placeholder="请输入用户ID..." clearable
              size="mini"></el-input>
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item prop="fileUrl">
            <el-upload class="upload-demo" :on-success="handleAvatarSuccess"
              :before-upload="beforeAvatarUpload" :on-error="handleUploadFailure" multiple
              :limit="1" accept=".xlsx" :file-list="fileList">
          ...
          <el-form-item>
            <div>
              <el-link :underline="false"
                href="https://szyh-ecommerce-oss.oss-cn-zhangjiakou.aliyuncs.com/commerce/product/1633261417031.xlsx"
        ...
        <el-table-column prop="" label="操作" align="center" width="150px">
          <template slot-scope="scope">
            <el-link icon="el-icon-view" :underline="false"
              @click="removeUser(scope.row)">移除</el-link>
          </template>
        </el-table-column>
      </el-table>
