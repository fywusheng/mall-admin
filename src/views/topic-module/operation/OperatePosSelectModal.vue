<template>
  <div class="main-content">
    <el-dialog title="选择运营位" :visible.sync="visible" width="1200px">
      <el-form :inline="true" size="small" label-width="80px" :model="search">
        ...
        <el-form-item label="">
          <el-input v-model="search.name" @keyup.native.enter="changeSize(pageSize)"
            placeholder="请输入运营位名称..." clearable size="small"></el-input>
        </el-form-item>

        <el-form-item label="">
          <el-input v-model="search.code" @keyup.native.enter="changeSize(pageSize)"
            placeholder="请输入运营位别名..." clearable size="small"></el-input>
        </el-form-item>
      ...
      <el-table class="custom-table" :data="dataList" v-if="dataList.length"
        ...
        <el-table-column align="center" label="运营位名称" prop="name">
          <template slot-scope="scope">
            <el-button type="text"
              @click.stop="selectOperatePos(scope.row)">{{scope.row.name}}</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="操作人" prop="user.userName"
      ...
      <el-pagination background v-show="totalSize > 10" :page-sizes="[10, 20, 50, 100]"
        :page-size="pageSize" @size-change="changeSize" @current-change="changePage"
        layout="total, sizes, slot, jumper, prev, pager, next" :total="totalSize">
      </el-pagination>
