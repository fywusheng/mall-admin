...
const name = defaultSettings.title || 'XX运营管理系统' // page title
...
module.exports = {
   ...
   */
  publicPath: '/nepsp-mall',
  outputDir: 'nepsp-mall',
  assetsDir: 'static',
